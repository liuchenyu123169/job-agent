...
from app.infrastructure.db.crud import get_resume_by_id, insert_task_traces, list_jobs_for_user
from app.shared.observability.tracer import get_current_spans, traced
