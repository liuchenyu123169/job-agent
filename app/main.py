...
from app.api.agent_run_api import router as agent_run_router
...
from app.shared.config import check_jwt_secret
...
def on_startup() -> None:
    ...
    try:
        from app.ai.skills.intent_classifier import build_skill_embeddings
